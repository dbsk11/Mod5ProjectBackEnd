...
Student.create(first_name: "Leina", last_name: Faker::Name.last_name, email: Faker::Internet.email, dob: Faker::Date.birthday(min_age: 10, max_age: 18), username: "Leina", password: "abc123")
39.times do 
...
Conversation.create(teacher_id: 1, student_id: 1, klass: "Biology", topic: "homework", urgency: "immediate", office_hours: true, description: "help", teacher_response: true, response: "check your email", office_hours_date: "August 1, 2020", time: "2:00PM")
Conversation.create(teacher_id: 3, student_id: 1, klass: "Algebra I", topic: "homework", urgency: "immediate", office_hours: false, description: "help", teacher_response: true, response: "check your email", office_hours_date: "August 1, 2020")
...
Conversation.create(teacher_id: 1, student_id: 2, klass: "Chemistry", topic: "classwork", urgency: "immediate", office_hours: true, description: "help", teacher_response: true, response: "check your email", office_hours_date: "August 1, 2020", time: "2:00PM")
Conversation.create(teacher_id: 1, student_id: 3, klass: "Physics", topic: "lecture", urgency: "end of day", office_hours: false, description: "help", teacher_response: true, response: "check your email", office_hours_date: "August 1, 2020")
Conversation.create(teacher_id: 1, student_id: 4, klass: "AP Biology", topic: "homework", urgency: "end of day", office_hours: false, description: "help", teacher_response: true, response: "check your email", office_hours_date: "August 1, 2020")
